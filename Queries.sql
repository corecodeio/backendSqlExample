-- SELECCIONE LAS PROPIEDADES DE LA TABLA USUARIO
-- PARA PODER VER LOS DATOS 

select USUARIO, CORREO, ADD_FECHA from USUARIO;

insert into USUARIO(USUARIO, CORREO, ADD_FECHA)
values ('QWERTY$123', 'QUERTY@gmail.com', CURRENT_TIMESTAMP);


insert into USUARIO(USUARIO, CORREO, ADD_FECHA)
values ('QWERTY$1234', 'QUERTYY@gmail.com', CURRENT_TIMESTAMP);
